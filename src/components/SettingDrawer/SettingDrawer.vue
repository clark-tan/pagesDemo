      ...
      <div class="setting-drawer-index-content">
          ...
          <div :style="{ marginTop: '24px' }">
            <a-list :split="false">
              <a-list-item>
                ...
                <a-select slot="actions" size="small" style="width: 80px;" :defaultValue="contentWidth" @change="handleContentWidthChange">
                  <a-select-option value="Fixed">固定</a-select-option>
        ...
        <div :style="{ marginBottom: '24px' }">
          ...
          <a-button
            ...
            @click="goSystemUrl"
            block
          ><CustomIcon :name="'onlineOfficeHall-iconzhengli_tiaozhuan'" class="iconButtonClass" />跳转运维系统</a-button>
        </div>
      </div>
...
export default {
  ...
  storageOptions: {
    ...
    goSystemUrl () {
      window.open(config.goSystemUrl)
    }
  }
}
</script>
